  ...
  return (
    <div className='p-4 py-8 md:p-8 lg:p-12 2xl:p-20'>
      <div className='flex flex-col gap-4'>
        <SectionTitle title={'Where We Excel'} className='mx-auto' />
        <h2 className='text-5xl font-bold text-center w-2/3 mx-auto !leading-tight'>
          Explore Our Expertise and{' '}
          <span className='text-secondary'>Impact Zones</span>
        </h2>
      </div>
      <div className='lg:w-max mx-auto text-center flex flex-col gap-3'>
        <h2 className='text-sm md:text-base lg:text-lg text-bg-color mx-auto font-bold'></h2>
        <h3 className='text-3xl md:text-4xl lg:text-5xl font-bold'></h3>
      </div>
